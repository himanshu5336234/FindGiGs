...
import { FreelancerCard } from "../ExploreTalent/Stylesheet";
import {
  StarFilled,
  DollarCircleFilled,
  EllipsisOutlined,
...
function FreelancerInfoCard({ freelancerData }) {
  return (
    <FreelancerCard className="profileDetails__freelancerCard">
      <Button
        icon={
          <EllipsisOutlined style={{ color: "#C9C9C9", fontSize: "21px" }} />
        }
        className="freelancerInfo__menu"
      />
      <div className="freelancerInfo__progressContainer">
        <GradientSVG
          idCSS={"gradientId" + freelancerData?.freelancerDetails?.id}
          startColor={"#13A46C"}
          endColor={"#3ACC6C"}
        />
        <CircularProgressbarWithChildren
          ...
          styles={{
            path: {
              // Path color
              stroke: `url(#${
                "gradientId" + freelancerData?.freelancerDetails?.id
              })`,
              height: "100%",
            },
          }}
      ...
      <GlobalTextP3 weight="bold" className="margin-b0 margin-t1">
        {freelancerData?.freelancerDetails?.user?.first_name}{" "}
        {freelancerData?.freelancerDetails?.user?.last_name}
      </GlobalTextP3>
      <GlobalTextP5 color="#696969" className="margin-b0">
        {freelancerData?.freelancerDetails?.user?.designation}
      </GlobalTextP5>
      <Space size={"middle"} wrap className="margin-t1 justify-center">
        <Space size={"small"}>
          <StarFilled
          ...
          <Space size={0} direction="vertical">
            ...
            <GlobalSubText className="margin-b0" color="#0C0E17" weight="bold">
              {freelancerData?.freelancerDetails?.ratings}
            </GlobalSubText>
          </Space>
        </Space>
        <Space size={"small"}>
          ...
          <Space size={0} direction="vertical">
            ...
            <GlobalSubText className="margin-b0" color="#0C0E17" weight="bold">
              Rs. {freelancerData?.freelancerDetails?.rate_per_hour}/Hr
            </GlobalSubText>
          </Space>
        </Space>
        <Space size={"small"}>
          <ProfileOutlined
            style={{ color: "#585CE5", fontSize: "28px", marginTop: "6px" }}
          />
          <Space size={0} direction="vertical">
            <p className="freelancer__rateTitle">EXPERIENCE</p>
            <GlobalSubText className="margin-b0" color="#0C0E17" weight="bold">
